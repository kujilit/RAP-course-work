...
conv = torchvision.ops.Conv2dNormActivation(in_channels=3, out_channels=3, kernel_size=3)
...
for element in path[:1]:
    image = Image.open('../dataset/' + element).resize((152, 152))
    ...
    try:
        ...
        print("Ошибка применения свертки")
    img_iter += 1
